...
void SFMLDebugDraw::DrawSolidCircle(const b2Vec2& center, float radius, const b2Vec2& axis, const b2Color& color)
{
	...
	sf::Vertex line[2] = 
	{
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(center), SFMLDebugDraw::GLColorToSFML(color)),
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(endPoint), SFMLDebugDraw::GLColorToSFML(color)),
	};
...
void SFMLDebugDraw::DrawSegment(const b2Vec2& p1, const b2Vec2& p2, const b2Color& color)
{
	sf::Vertex line[] =
	{
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(p1), SFMLDebugDraw::GLColorToSFML(color)),
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(p2), SFMLDebugDraw::GLColorToSFML(color))
	};
...
void SFMLDebugDraw::DrawTransform(const b2Transform& xf)
{
	...
	sf::Vertex greenLine[] = 
	{
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(xf.p), sf::Color::Green),
		sf::Vertex(utils::B2VecToSFVec<sf::Vector2f>(yAxis), sf::Color::Green)
	};
